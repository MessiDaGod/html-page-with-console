...
(function ()
{
    ...
    window.Shakely = {
        ...
        plot: function ( /** @type {string | URL} */ url)
        {
            ...
            if(this.url == null) this.url = "https://api.binance.com/api/v3/klines?symbol=BTCUSDT&interval=1d&limit=100";
            ...
            xmlhttp.onreadystatechange = function ()
            {
                if(xmlhttp.readyState === 4 && xmlhttp.status === 200)
                {
                    ...
                    {
                        Shakely.addCandlestick(new Shakely.candleStick(json[i][0], // timestamp
                            json[i][1], // open
                            json[i][4], // close
                            json[i][2], // high
                            json[i][3], // low
        ...
        scroll: function ( /** @type {{ deltaY: number; }} */ e)
        {
            ...
            new Log(parseInt(newLimit += Shakely.zoomStartID));
        ...
        draw: function ()
        {
            ...
            if(Shakely.b_drawMouseOverlay)
            {
                ...
                Shakely.drawLine(0, Shakely.mousePosition.y, Shakely.width, Shakely.mousePosition.y, Shakely.mouseHoverBackgroundColor);
                // time line
                Shakely.context.setLineDash([5, 5]);
                ...
                Shakely.fillRect(Shakely.width - 70, Shakely.mousePosition.y - 10, 70, 20, Shakely.mouseHoverBackgroundColor);
                ...
                Shakely.context.fillText(str, Shakely.width - textWidth - 5, Shakely.mousePosition.y + 5);
                // time line
                Shakely.context.setLineDash([5, 5]);
                Shakely.drawLine(Shakely.mousePosition.x, 0, Shakely.mousePosition.x, Shakely.height, Shakely.mouseHoverBackgroundColor);
                ...
                Shakely.fillRect(Shakely.mousePosition.x - textWidth / 2 - 5, Shakely.height - 20, textWidth + 10, 20, Shakely.mouseHoverBackgroundColor);
                Shakely.context.fillStyle = Shakely.mouseHoverTextColor;
                Shakely.context.fillText(str, Shakely.mousePosition.x - textWidth / 2, Shakely.height - 5);
                // data
                var yPos = Shakely.mousePosition.y - 95;
                if(yPos < 0) yPos = Shakely.mousePosition.y + 15;
                Shakely.fillRect(Shakely.mousePosition.x + 15, yPos, 100, 80, Shakely.mouseHoverBackgroundColor);
                ...
                Shakely.context.lineWidth = 1;
                Shakely.context.fillStyle = Shakely.mouseHoverTextColor;
                Shakely.context.fillText("Open: " + Shakely.candlesticks[Shakely.hoveredCandlestickID].open.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,'), Shakely.mousePosition.x + 30, yPos + 15);
                Shakely.context.fillText("Close: " + Shakely.candlesticks[Shakely.hoveredCandlestickID].close.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, "$&,"), Shakely.mousePosition.x + 30, yPos + 35);
                Shakely.context.fillText("High: " + Shakely.candlesticks[Shakely.hoveredCandlestickID].high.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, "$&,"), Shakely.mousePosition.x + 30, yPos + 55);
                Shakely.context.fillText("Low: " + Shakely.candlesticks[Shakely.hoveredCandlestickID].low.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, "$&,"), Shakely.mousePosition.x + 30, yPos + 75);
            }
        },
        ...
        setCurrentPrice: function ( /** @type {any} */ url)
        {
            Shakely.plot(url);
        },
        drawGrid: function ()
        {
            ...
            for(var y = yStartRoundNumber; y <= yEndRoundNumber; y += niceNumber)
            {
                ...
                var textWidth = Shakely.context.measureText(Shakely.roundPriceValue(y)).width;
                ...
                Shakely.context.fillText(Shakely.roundPriceValue(y), Shakely.width - textWidth - 5, Shakely.yToPixelCoords(y) - 5);
                Shakely.context.fillStyle = Shakely.gridTextColor;
                Shakely.context.fillText(Shakely.roundPriceValue(currentprice), Shakely.width - textWidth - 5, Shakely.yToPixelCoords(currentprice) - 5);
            ...
            for(var x = xStartRoundNumber; x <= xEndRoundNumber; x += niceNumber)
            {
                ...
                Shakely.context.fillStyle = Shakely.gridTextColor;
                Shakely.context.fillText(dateStr, Shakely.xToPixelCoords(x) + 5, Shakely.height - 5);
            }
        },
        ...
        {
            if(document.getElementById("candlestick") && document.getElementById("candlestick").style.width != "1600") document.getElementById("candlestick").style.width = "1600";
        },
    };
}());